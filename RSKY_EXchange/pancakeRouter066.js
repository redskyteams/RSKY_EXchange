...
library PancakeLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'ccd40c8c5c5f06a34ff7a78ef4c47f978b59e9e0223524dbc6695ca599c44eb1' // init code hash
            ))));
    }
    ...
    function getAmountOut(uint amountIn, uint reserveIn, uint reserveOut) internal pure returns (uint amountOut) {
        ...
        uint amountInWithFee = amountIn.mul(9932);
    ...
    function getAmountIn(uint amountOut, uint reserveIn, uint reserveOut) internal pure returns (uint amountIn) {
        ...
        uint denominator = reserveOut.sub(amountOut).mul(9932);
...
contract PancakeRouter is IPancakeRouter02 {
    ...
    function getPrice(address token1,address token2) public view returns(uint256 amount1,uint256 amount2){
        (amount1,amount2) = PancakeLibrary.getReserves(factory, token1, token2);
